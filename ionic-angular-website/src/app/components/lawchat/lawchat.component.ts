...
@Component({
  selector: 'app-lawchat',
  templateUrl: './lawchat.component.html',
  styleUrls: ['./lawchat.component.scss'],
})
export class LawChatComponent {
  @ViewChild('messageswindow') private messagesContainer!: ElementRef;
    ...
    constructor(public loading: LoadingService ,private cookieService: CookieService ,private apiService: ApiService,private ngZone: NgZone){
